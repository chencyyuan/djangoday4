...
class Article(models.Model):
    ...
    date=models.DateTimeField(auto_now=True,verbose_name='发表日期')
    ...
    user=models.ForeignKey(to=UserProfile,on_delete=models.CASCADE,verbose_name='作者',related_name='article_auth')
    collect=models.ManyToManyField(to=UserProfile,verbose_name='收藏',related_name='article_user')
